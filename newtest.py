...
def calculator(im):
    #cv2.rectangle(im,(400,200),(450,250),(255,0,0),2)
    #cv2.putText(im, '1', (415, 235), font, 1, (0, 255, 0), 2, cv2.LINE_AA)  #1
    #cv2.rectangle(im, (460, 200), (510, 250), (255, 0, 0), 2)
    #cv2.putText(im, '2', (475, 235), font, 1, (0, 255, 0), 2, cv2.LINE_AA)  #2
    #cv2.rectangle(im, (400, 140), (450, 190), (255, 0, 0), 2)
    #cv2.putText(im, '4', (415, 175), font, 1, (0, 255, 0), 2, cv2.LINE_AA)  #4
    size = 70
    y=200
    num=1
    for j in range (1,4):
